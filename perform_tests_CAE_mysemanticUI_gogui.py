...
#from eval_metric_gogui.get_overall_IOU import get_overall_IOU
...
data_dir = '/home/dipu/dipu_ps/codes/GraphEncoding-GoogleUI/SemanticGogUIs_2/'
...
gallery_uis = list(set(gallery_uis) - set(['0001844.png', '0017747.png', '0015818.png']))
...
#                                               drop_last = True, pin_memory=True, num_workers=16)
    ...
    model_path = 'runs_MySemanticUI/%s/ckp_ep20.pth.tar'%(args.model_name)
