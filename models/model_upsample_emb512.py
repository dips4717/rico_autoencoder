...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov  1 11:32:27 2019
...
class CAE_upsample_dim512(nn.Module):
    def __init__ (self):
        super(CAE_upsample_dim512, self).__init__()
        ...
        self.FC1 = nn.Linear(32*14*6, 512)
        self.FC2 = nn.Linear(512, 32*14*6)
...
#               )
    ...
    def forward(self, x, training = True):
        ...
        if not(training): 
            ...
            x_rec = x_rec.reshape(x_rec.size(0),32,14,6)            
